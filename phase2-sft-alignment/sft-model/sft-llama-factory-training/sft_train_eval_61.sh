...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/gemma2/gemma-2-9b-it_lora_sft_1.yaml
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/gemma2/gemma-2-9b-it_lora_sft_2.yaml
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/gemma2/gemma-2-9b-it_lora_sft_3.yaml
