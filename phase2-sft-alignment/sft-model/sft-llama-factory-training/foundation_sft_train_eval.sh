...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/chatglm3-6b-32k_foundation_predict.yaml
...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/gemma-1.1-7b-it_foundation_predict.yaml
...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/gemma-2-9b-it_foundation_predict.yaml
...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/glm-4-9b-chat-1m_foundation_predict.yaml
...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/internlm2-chat-7b_foundation_predict.yaml
...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/internlm2_5-7b-chat_foundation_predict.yaml
...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/Llama-2-7b-chat-hf_foundation_predict.yaml
...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/Meta-Llama-3-8B-Instruct_foundation_predict.yaml
...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/Mistral-7B-Instruct-v0.3_foundation_predict.yaml
...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/Phi-3-mini-4k-instruct_foundation_predict.yaml
...
CUDA_VISIBLE_DEVICES=1 llamafactory-cli train examples/train_lora/Phi-3-small-8k-instruct_foundation_predict.yaml
